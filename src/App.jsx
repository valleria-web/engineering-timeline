...
const knownPrinciples = [
  ...
  },
  {
    ...
    assocTitle:
      "BricksChallenge → soporte mecánico para hidráulica (transmisión de potencia a elevadores/bombas).",
    assoc: [
      "BC-4 Belt Transmission — transmisión a poleas/norias (soporte mecánico)",
      "BC-5 Gear, Chain, and Snail Transmissions — relación de torque/velocidad para bombas (soporte mecánico)",
      "BC-6 Crown Gear Transmission — cambio de eje 90° (rueda hidráulica ↔ bomba) (soporte mecánico)",
    ],
  },
  {
    id: 4,
...
const reversedPrinciples = [
  {
    ...
    era: "≈ indeterminate ",
    place: "Egipto",
    principle: "Relevancia: Precisión geométrica y astronómica extraordinaria.",
    detailsTitle: "La Gran Pirámide tiene:",
    details: [
      "Alineación casi perfecta con el norte verdadero.",
      "Errores de construcción de apenas milímetros en bloques de varias toneladas.",
      "Diseño matemático que parece conocer proporciones geométricas avanzadas (π, proporción áurea, etc.).",
    ],
    precisionTitle: "Principios ligados a la precisión:",
    precisionPoints: [
      "#2 Estática · Base nivelada, ortogonalidad y plomada; control de errores angulares y de asentamiento.",
      "#4 Cinemática celeste · Alineación con tránsito solar/estelar usando sombras y estrellas circumpolares.",
      "#7 Óptica geométrica · Líneas de mira (gnomon), control de sombras en fechas clave.",
      "#9 Control/Metrología · Mediciones redundantes, ajuste y corrección iterativa (feedback).",
      "#8 Resistencia de materiales · Mantener la geometría bajo carga y dilataciones térmicas.",
    ],
  },
  {
    id: -2,
...
const mathMap = {
  1: {
    title: "Geometría (empírica) medición de áreas, volúmenes o distancias",
    principal: "Geometría y Topología",
    secondary: "Álgebra de Transición (trigonometría)",
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-6 md:mb-8">
          ...
          <div className="mt-3 p-3 md:p-4 rounded-xl border bg-amber-50 text-amber-900 text-sm md:text-base leading-relaxed">
            <b>Nota histórica.</b> La práctica de la <b>ingeniería</b> (construcción, canales, herramientas) antecede a la <b>matemática formal</b>. Con el tiempo, las matemáticas pasan a <b>formalizar</b> y <b>potenciar</b> la ingeniería. En esta tabla: cada fila cruza <i>Principio de ingeniería</i> ↔ <i>Programas educativos</i> ↔ <i>Matemáticas relacionadas</i> ↔ <i>Reversión</i>, indicando <u>Grupo matemático principal (secundario)</u> y <u>personajes representativos</u>.
          </div>
          ...
          <div className="mt-2 flex items-center gap-3">
            <div className="inline-flex items-center gap-2 text-xs md:text-sm">
              ...
              <span className="inline-flex items-center px-2 py-0.5 rounded-full border bg-indigo-50 text-indigo-800 border-indigo-200">Formalizado después</span>
            </div>
          </div>
